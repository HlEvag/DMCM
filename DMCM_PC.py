...
utils.classification_map(hsi_pic[4:-4, 4:-4, :], best_G[4:-4, 4:-4], 24,  "classification_results/PC_new_mmd{}shot.png".format(TEST_LSAMPLE_NUM_PER_CLASS))

file_name = r"classification_results/PC_9x9_MD1_10_self_new_mmmd_report.txt"
